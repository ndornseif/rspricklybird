...
/// # Usage
/// ```
/// use pricklybirdlib::constants::WORDLIST;
...
/// # Usage
/// ```
/// use pricklybirdlib::constants::BYTE_WORDLIST;
/// assert_eq!([102, 108, 117, 120], BYTE_WORDLIST[0x43]); // "flux" in ASCII.
/// ```
...
/// Letters are expected to be the in the range `a-z` as lowercase ASCII characters.
/// Outside that range the index zero is returned.
///
/// # Usage
/// ```
...
/// assert_eq!("flux", WORDLIST[byte_value as usize]);
/// ```
#[must_use]
...
/// Defines the size of the words to bytes table `HASH_TABLE`.
///
